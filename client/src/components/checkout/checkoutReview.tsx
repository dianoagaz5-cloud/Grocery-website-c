import { CheckIcon, ChevronLeftIcon, TruckIcon } from "lucide-react";
...
export default function CheckoutReview({ address, items, handlePlaceOrder, loading, total, setStep }: CheckoutReviewProps) {
    ...
    return (
        <div className="bg-white rounded-2xl p-6 animate-fade-in">
            ...
            <button
                ...
                className="flex items-center gap-1 text-xs text-app-text-light hover:text-app-green transition-colors mb-5 cursor-pointer"
            >
                <ChevronLeftIcon className="size-4" /> Back to Payment
            </button>
